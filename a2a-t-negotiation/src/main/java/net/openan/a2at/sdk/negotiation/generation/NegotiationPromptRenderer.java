 ...
 * such as {@code {{所需信息项}}（必填）} or {@code {{Required Information Items}} (required)} is a slot section: it is rendered
 * as the title followed by the slot value, or dropped entirely when the slot value is null or blank. Every other
 * section is static and passes through with placeholder substitution applied. Rendered sections are joined with a
 * single blank line and the result carries no trailing newline.
 *
 * @since 2026-06
 */
